...
from dataset.stereo_albumentation import RGBShiftStereo, RandomBrightnessContrastStereo, aligned_random_crop
...
class KITTIBaseDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if not self.split == 'test':  # no disp for test files
            ...
            if self.split == 'train':
                input_data = aligned_random_crop(200, 640, input_data, self.split)
